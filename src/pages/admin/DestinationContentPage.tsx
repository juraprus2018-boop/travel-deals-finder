...
import { ArrowLeft, Sparkles, Check, Loader2, RefreshCw, Eye } from "lucide-react";
...
const pageTypes: { id: PageType; label: string; icon: string }[] = [
  { id: "main", label: "Hoofdpagina", icon: "📄" },
  { id: "hotels", label: "Hotels", icon: "🏨" },
  { id: "bezienswaardigheden", label: "Bezienswaardigheden", icon: "🎯" },
  { id: "vliegtickets", label: "Vliegtickets", icon: "✈️" },
];
